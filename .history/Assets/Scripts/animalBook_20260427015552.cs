...
public class animalBook : MonoBehaviour
{
    ...
    private void Start() {
        InitialState();
        Debug.Log("firstCreatureCollected = " + QuestManager.Instance.firstCreatureCollected);
        ...
        if (QuestManager.Instance != null && QuestManager.Instance.firstCreatureCollected)
        {
